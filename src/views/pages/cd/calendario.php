...
?>
<?= $render('header', [
    'pageTitle' => 'Calendário de Recebimento',
    'showNavbar' => true,
    'pageActive' => 'calendario',
    'customCSS' => ['src/css/recibo-print.css'],
    'bodyStyle' => 'background-color: #f5f7fa; min-height: 100vh; font-family: \'Segoe UI\', Tahoma, Geneva, Verdana, sans-serif;'
]) ?>
...
<div class="container">
    ...
    <div class="calendar-controls">
                ...
                <div class="modal-body">
                    <form id="formRecibo">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cnpjCpf" name="cnpjCpf" placeholder="000.000.000-00" maxlength="18">
                        </div>

                        <div class="form-group">
                            <label for="valorPago">Valor Pago (R$) *</label>
                            <input type="text" id="valorPago" name="valorPago" placeholder="R$ 0,00" required>
                        </div>
        ...
        <div id="modalVisualizarRecibo" class="modal" style="display: none;">
            <div class="modal-content modal-recibo-print" style="width: 900px; min-width: 320px; max-width: 98vw; margin: 0 auto; overflow-y: auto; max-height: 90vh;">
...
<?= $render('footer', [
    'customJS' => ['src/js/cd-calendario.js']
]) ?>
