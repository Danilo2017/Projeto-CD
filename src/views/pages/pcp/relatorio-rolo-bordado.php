...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Rolo Bordado',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-rolo-bordado',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-cpu"></i> Sequência de Produção — Rolo Bordado</h4>
...
<script src="src/js/relatorio-rolo-bordado.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-rolo-bordado.js') ?: '1' ?>"></script>
