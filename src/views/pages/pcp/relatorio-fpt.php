...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — FPT',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-fpt',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-scissors"></i> Sequência de Produção — FPT</h4>
...
<script src="src/js/relatorio-fpt.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-fpt.js') ?: '1' ?>"></script>
