...
?>
<?= $render('header', [
    'pageTitle'  => 'PCP Molas — Cordão de Molas',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-pcp-cordao',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-gear-wide-connected"></i> PCP Molas — Cordão de Molas</h4>
...
<script src="<?= $base ?>src/js/relatorio-pcp-cordao.js?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/src/js/relatorio-pcp-cordao.js') ?: date('YmdH') ?>"></script>
<?= $render('footer') ?>
