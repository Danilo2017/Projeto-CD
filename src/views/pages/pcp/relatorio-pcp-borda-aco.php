...
?>
<?= $render('header', [
    'pageTitle'  => 'PCP Molas — Borda de Aço',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-pcp-borda-aco',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-border-style"></i> PCP Molas — Borda de Aço</h4>
...
<script src="<?= $base ?>src/js/relatorio-pcp-borda-aco.js?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/src/js/relatorio-pcp-borda-aco.js') ?: date('YmdH') ?>"></script>
<?= $render('footer') ?>
