...
?>
<?= $render('header', [
    'pageTitle'  => 'PCP Molas — Quantidade de Tampo',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-pcp-tampo',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-layers"></i> PCP Molas — Quantidade de Tampo</h4>
...
<script src="<?= $base ?>src/js/relatorio-pcp-tampo.js?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/src/js/relatorio-pcp-tampo.js') ?: date('YmdH') ?>"></script>
<?= $render('footer') ?>
