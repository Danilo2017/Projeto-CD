...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Vertical Espuma',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-vertical-espuma',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-stack"></i> Sequência de Produção — Vertical Espuma</h4>
...
<script src="src/js/relatorio-vertical-espuma.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-vertical-espuma.js') ?: '1' ?>"></script>
