...
?>
<?= $render('header', [
    'pageTitle'  => 'Trave Pezê — Sequência de Produção',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-trave-peze',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-cpu"></i> Trave Pezê — Sequência de Produção</h4>
...
<script src="src/js/relatorio-trave-peze.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-trave-peze.js') ?: '1' ?>"></script>
