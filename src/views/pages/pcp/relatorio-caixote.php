...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Caixote',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-caixote',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-box-seam"></i> Sequência de Produção — Caixote</h4>
...
<script src="src/js/relatorio-caixote.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-caixote.js') ?: '1' ?>"></script>
