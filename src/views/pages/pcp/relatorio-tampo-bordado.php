...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Tampo Bordado',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-tampo-bordado',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-layers-half"></i> Sequência de Produção — Tampo Bordado</h4>
...
<script src="src/js/relatorio-tampo-bordado.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-tampo-bordado.js') ?: '1' ?>"></script>
