...
?>
<?= $render('header', [
    'pageTitle'  => 'PCP Molas — Quantidade de Molinhas',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-pcp-molas',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-gear-wide-connected"></i> PCP Molas — Quantidade de Molinhas</h4>
        <div class="row g-3 align-items-end">
            <div class="col-md-2">
                <label class="form-label fw-semibold">Nº do Lote</label>
                <input type="number" id="inputLote" class="form-control form-control-sm" placeholder="Ex: 3" min="1">
            </div>
            <div class="col-auto">
...
<script src="<?= $base ?>src/js/relatorio-pcp-molas.js?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/src/js/relatorio-pcp-molas.js') ?: date('YmdH') ?>"></script>
<?= $render('footer') ?>
