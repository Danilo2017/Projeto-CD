...
?>
<?= $render('header', [
    'pageTitle'  => 'Seq. Disco de Corte',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-disco-de-corte',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-scissors"></i> Seq. Disco de Corte</h4>
...
<script src="src/js/relatorio-disco-de-corte.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-disco-de-corte.js') ?: '1' ?>"></script>
