...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Mesa de Faixa',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-mesa-faixa',
...
.pcp-table tr.subtotal-row td { background:#dce6f1;font-weight:bold; }
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-layout-text-window-reverse"></i> Sequência de Produção — Mesa de Faixa</h4>
...
<script src="src/js/relatorio-mesa-faixa.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-mesa-faixa.js') ?: '1' ?>"></script>
