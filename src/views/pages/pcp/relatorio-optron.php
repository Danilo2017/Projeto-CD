...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Optron',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-optron',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-grid-3x3-gap"></i> Sequência de Produção — Optron</h4>
...
<script src="src/js/relatorio-optron.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-optron.js') ?: '1' ?>"></script>
