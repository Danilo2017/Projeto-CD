...
?>
<?= $render('header', [
    'pageTitle'  => 'Colchão Box — Sequência de Produção',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-tapecaria',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-cpu"></i> Colchão Box — Sequência de Produção</h4>
...
<script src="src/js/relatorio-tapecaria.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-tapecaria.js') ?: '1' ?>"></script>
