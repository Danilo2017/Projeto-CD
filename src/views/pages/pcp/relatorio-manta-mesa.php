...
?>
<?= $render('header', [
    'pageTitle'  => 'Sequência de Produção — Manta Mesa',
    'showNavbar' => true,
    'pageActive' => 'pcp-relatorio-manta-mesa',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-stack"></i> Sequência de Produção — Manta Mesa</h4>
...
<script src="src/js/relatorio-manta-mesa.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/relatorio-manta-mesa.js') ?: '1' ?>"></script>
