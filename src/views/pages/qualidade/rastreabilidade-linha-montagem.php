...
/** @var string   $base */
/** @var callable $render */
$acesso = $is_admin || in_array('qualidade', $rotas_permitidas) || in_array('*', $rotas_permitidas);
if (!$acesso) {
...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade Linha de Montagem',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-linha-montagem',
...
.pcp-table tr.subtotal-row td { background:#dce6f1;font-weight:bold;border:none; }
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-shield-check"></i> Rastreabilidade Linha de Montagem</h4>
        <div class="row g-3 align-items-end">
            <div class="col-md-2">
                <label class="form-label fw-semibold">Nº do Lote</label>
                <input type="number" id="inputLote" class="form-control form-control-sm" placeholder="Ex: 92" min="1">
            </div>
            <div class="col-auto">
...
<script src="<?= $base ?>src/js/qualidade-rastreabilidade-linha-montagem.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-linha-montagem.js') ?: '1' ?>"></script>
<?= $render('footer') ?>
