...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade — Fabricação Borda',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-borda-molas',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-gear-wide-connected"></i> Rastreabilidade — Fabricação Borda</h4>
...
<script src="src/js/qualidade-rastreabilidade-borda-molas.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-borda-molas.js') ?: '1' ?>"></script>
