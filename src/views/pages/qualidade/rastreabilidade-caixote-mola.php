...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade — Caixote de Mola',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-caixote-mola',
...
.pcp-table td.td-blank { min-width:80px; }
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-shield-check"></i> Rastreabilidade — Caixote de Mola</h4>
...
<script src="<?= $base ?>src/js/qualidade-rastreabilidade-caixote-mola.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-caixote-mola.js') ?: '1' ?>"></script>
<?= $render('footer') ?>
