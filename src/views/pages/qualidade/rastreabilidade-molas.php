...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade — Fabricação Molinhas',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-molas',
...
/* Header fiel ao documento físico */
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-gear-wide-connected"></i> Rastreabilidade — Fabricação Molinhas</h4>
...
<script src="src/js/qualidade-rastreabilidade-molas.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-molas.js') ?: '1' ?>"></script>
