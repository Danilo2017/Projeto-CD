...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade Costura — Tampo Liso',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-costura',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-shield-check"></i> Rastreabilidade Costura — Tampo Liso</h4>
...
<script src="<?= $base ?>src/js/qualidade-rastreabilidade-costura.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-costura.js') ?: '1' ?>"></script>
<?= $render('footer') ?>
