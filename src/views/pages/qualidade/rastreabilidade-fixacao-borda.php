...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade — Fixação de Borda',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-fixacao-borda',
...
.rastr-subheader .sub-row1 { padding:3px 8px; }
...
.rastr-table th { background:#1f3864;color:#fff;border:1px solid #999;padding:4px 6px;text-align:center;font-weight:bold; }
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-gear-wide-connected"></i> Rastreabilidade — Fixação de Borda</h4>
...
<script src="src/js/qualidade-rastreabilidade-fixacao-borda.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-fixacao-borda.js') ?: '1' ?>"></script>
