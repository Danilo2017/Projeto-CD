...
?>
<?= $render('header', [
    'pageTitle'  => 'Rastreabilidade Bordadeira — Tampo',
    'showNavbar' => true,
    'pageActive' => 'qualidade-rastreabilidade-tampo-bordado',
...
<div class="comissao-dashboard-container" style="width:100%;max-width:100%;padding:10px;margin:0;">
    ...
    <div class="pcp-form-card">
        <h4 class="mb-3"><i class="bi bi-shield-check"></i> Rastreabilidade Bordadeira — Tampo</h4>
        <div class="row g-3 align-items-end">
            <div class="col-md-2">
                <label class="form-label fw-semibold">Nº do Lote</label>
                <input type="number" id="inputLote" class="form-control form-control-sm" placeholder="Ex: 115" min="1">
            </div>
            <div class="col-auto">
...
<script src="<?= $base ?>src/js/qualidade-rastreabilidade-tampo-bordado.js?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/src/js/qualidade-rastreabilidade-tampo-bordado.js') ?: '1' ?>"></script>
<?= $render('footer') ?>
