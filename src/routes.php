...
$router->get('/faturamento-analise-tanque', 'Faturamento\\EficienciaUepController@analiseTanque', true);
$router->get('/faturamento-analise-tanque-clas', 'Faturamento\\EficienciaUepController@analiseTanqueClas', true);
$router->get('/faturamento-api-eficiencia-uep', 'Faturamento\\EficienciaUepController@listar', true);
$router->get('/faturamento-api-eficiencia-uep-tanques', 'Faturamento\\EficienciaUepController@tanques', true);
$router->get('/faturamento-api-eficiencia-uep-detalhe', 'Faturamento\\EficienciaUepController@detalhe', true);
$router->get('/faturamento-api-analise-tanque-clas', 'Faturamento\\EficienciaUepController@apiClassificacoesPorTanque', true);
...
$router->post('/qualidade-api-rastreabilidade-cordao-molas',    'Qualidade\\RastreabilidadeController@buscarCordaoMolas',   true);
$router->get('/qualidade-rastreabilidade-borda-molas',          'Qualidade\\RastreabilidadeController@indexBordaMolas',     true);
$router->post('/qualidade-api-rastreabilidade-borda-molas',     'Qualidade\\RastreabilidadeController@buscarBordaMolas',    true);
$router->get('/qualidade-rastreabilidade-fixacao-borda',        'Qualidade\\RastreabilidadeController@indexFixacaoBorda',   true);
$router->post('/qualidade-api-rastreabilidade-fixacao-borda',   'Qualidade\\RastreabilidadeController@buscarBordaMolas',    true);
$router->get('/qualidade-rastreabilidade-caixote-mola',         'Qualidade\\RastreabilidadeController@indexCaixoteMola',    true);
$router->post('/qualidade-api-rastreabilidade-caixote-mola',    'Qualidade\\RastreabilidadeController@buscarCaixoteMola',   true);
