(function () {
    ...
    /* ── Renderiza rastreabilidade Fixação de Borda ─ */
    function renderFixacaoBorda(rows, numLote) {
        const hoje = dataHoje();
        ...
        if (rows && rows.length > 0) {
            ...
            <tr>
                ...
                <td class="text-center">${fmt(r.MASCARA)}</td>
            ...
            corpoTabela = '<tr><td colspan="11" class="text-center text-muted">Nenhum dado encontrado para este lote.</td></tr>';
        }
...
<div class="rastr-section">
    <div class="rastr-header">
        ...
        <div class="col-title">RASTREABILIDADE FIXAÇÃO DE BORDA</div>
        <div class="col-setor">
    ...
    <div class="rastr-subheader">
        <div class="sub-row1">
            <span class="sub-code">R.16.MOL-04</span>
    ...
    <table class="rastr-table">
        <thead>
            <tr>
                ...
                <th>MESA</th>
                <th>LOTE DA<br>BORDA</th>
                <th>NF / LOTE<br>EDGE CLIPE</th>
                <th>NF / LOTE<br>DO GRAMPO</th>
            </tr>
        </thead>
...
<meta charset="utf-8">
<title>Rastreabilidade — Fixação de Borda</title>
<style>
  ...
  .rastr-section{box-shadow:none;border-radius:0;margin:0;padding:10px 14px}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnGerar.addEventListener('click', async function () {
            ...
            try {
                const res  = await fetch('qualidade-api-rastreabilidade-fixacao-borda', {
                    method:  'POST',
                ...
                printArea.innerHTML = renderFixacaoBorda(data.rows || [], numLote);
