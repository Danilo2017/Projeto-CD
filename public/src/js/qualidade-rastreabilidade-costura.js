(function () {
    ...
    function renderRastreabilidadeCostura(rows, numLote, dataLote) {
        ...
        const loteTitulo = dataLote
            ? `TAMPO LISO - LOTE ${numLote} ${dataLote}`
            : `TAMPO LISO - LOTE ${numLote}`;
...
<div class="pcp-section">
    <div class="pcp-report-header">
        ...
        <div class="col-title">RASTREABILIDADE COSTURA- TAMPO LISO</div>
        <div class="col-right">
...
<meta charset="utf-8">
<title>Rastreabilidade Costura — Tampo Liso</title>
<style>
...
@media print{body{background:#fff;padding:0}.pcp-section{page-break-after:always;box-shadow:none;border-radius:0;margin:0;padding:10px 14px}.pcp-section:last-child{page-break-after:avoid}.pcp-table td.td-wrap{white-space:normal;word-break:break-word}}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnGerar.addEventListener('click', async function () {
            ...
            try {
                const res  = await fetch('qualidade-api-rastreabilidade-costura', {
                    method:  'POST',
                ...
                const html = renderRastreabilidadeCostura(data.tampo_rows || [], numLote, data.data_lote || '');
