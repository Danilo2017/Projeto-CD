(function () {
    ...
    /* ── Renderiza rastreabilidade Molas ──────── */
    function renderMolas(rows, numLote, dataLote) {
        const hoje = dataHoje();
        ...
        if (rows && rows.length > 0) {
            ...
            <tr>
                ...
                <td class="text-center">${fmt(r.COD_ITEM_MOLA)}</td>
...
<div class="rastr-section">
    <div class="rastr-header">
        ...
        <div class="col-title">RASTREABILIDADE - FABRICAÇÃO MOLINHAS</div>
        <div class="col-setor">
    ...
    <div class="rastr-subheader">
        <div class="sub-row1">
            <span class="sub-code">R.16.MOL-01</span>
    ...
    <table class="rastr-table">
        <thead>
            <tr>
                ...
                <th>CÓD. MOLA</th>
                <th>DESC. MOLA</th>
                <th>TOTAL<br>MOLINHAS</th>
                <th>MÁQUINA</th>
                <th>NF / LOTE DO ARAME</th>
                <th>NF / LOTE TNT</th>
            </tr>
        </thead>
...
<meta charset="utf-8">
<title>Rastreabilidade — Fabricação Molinhas</title>
<style>
  ...
  .rastr-section{box-shadow:none;border-radius:0;margin:0;padding:10px 14px}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnGerar.addEventListener('click', async function () {
            ...
            try {
                const res  = await fetch('qualidade-api-rastreabilidade-molas', {
                    method:  'POST',
                ...
                printArea.innerHTML = renderMolas(data.rows || [], numLote, data.data_lote || '');
