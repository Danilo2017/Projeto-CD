(function () {
    ...
    function renderFpt(rows, numLote, dataLote, pillowLinear) {
        ...
        corpoTabela += `
        <tr class="subtotal-row">
            <td colspan="5" style="text-align:right;font-weight:bold">ROBOTEC:</td>
            <td style="text-align:center">${fmtDecimal(linRobotec)}</td>
            <td colspan="3"></td>
        </tr>
        <tr class="subtotal-row">
            <td colspan="5" style="text-align:right;font-weight:bold">CONJUGADO:</td>
            <td style="text-align:center">${fmtDecimal(linearConjugado)}</td>
            <td colspan="3"></td>
        </tr>
        <tr class="subtotal-row">
            <td colspan="5" style="text-align:right;font-weight:bold">PILLOW:</td>
