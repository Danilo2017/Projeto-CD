(function () {
    ...
    function renderHorizontalEspuma(rows, numLote, dataLote) {
        ...
        const titulo = `HORIZONTAL – ESPUMA - LOTE ${numLote}${dataLote ? ' (' + dataLote + ')' : ''}`;
...
<meta charset="utf-8">
<title>Sequência de Produção — Horizontal Espuma</title>
<style>
  ...
  .pcp-section:last-child{page-break-after:avoid}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnGerar.addEventListener('click', async function () {
            ...
            try {
                const res  = await fetch('pcp-api-relatorio-horizontal-espuma', {
                    method:  'POST',
                ...
                const html = renderHorizontalEspuma(data.rows || [], numLote, data.data_lote || '');
