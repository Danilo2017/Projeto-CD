(function () {
    ...
    const DOC_CODE     = 'R.14.GEP-32';  // Manta Mesa
    ...
    function renderMantaMesa(rows, numLote, dataLote) {
...
<div class="pcp-section">
    ...
    <div class="pcp-section-title">
        MANTA MESA - LOTE ${numLote}${dataLote ? ' (' + dataLote + ')' : ''}
    </div>
...
<meta charset="utf-8">
<title>Sequência de Produção — Manta Mesa</title>
<style>
  ...
  .pcp-table td.td-wrap{white-space:normal;word-break:break-word}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnGerar.addEventListener('click', async function () {
            ...
            try {
                const res  = await fetch('pcp-api-relatorio-manta-mesa', {
                    method:  'POST',
                ...
                printArea.innerHTML = renderMantaMesa(data.manta_rows || [], numLote, data.data_lote || '');
